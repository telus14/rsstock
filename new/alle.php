...
if(isset($_POST['enviar'])){
    ...
    $query = mysqli_query($mysqli, "UPDATE allio SET estoque = 0 WHERE numero = $numero");
    $query = mysqli_query($mysqli, "UPDATE allio SET client_f = '$client' WHERE numero = '$numero'");
    if($query){
        echo 'ADCIONADO';
    } else {
        echo 'nao deu';
